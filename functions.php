...
class theMostPopularArticle extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id( 'posts_per_page' ); ?>" name="<?php echo $this->get_field_name( 'posts_per_page' ); ?>" type="text" value="<?php echo ( ( !empty( $posts_per_page ) ) && ( $posts_per_page ) ) ? esc_attr( $posts_per_page ) : '6'; ?>" size="3" />
		</p>
		<p>
